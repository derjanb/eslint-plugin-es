...
function definePrototypeMethodHandler(context, nameMap) {
    ...
    function initializerToClassName(tsNode) {
        ...
        if (
            ...
            ["String", "Array", "Promise", "RegExp", "Function"].includes(et)
        ) {
            return et
        }
        if (
            ...
            ["String", "Array", "Promise", "Function", "RegExp"].includes(et)
        ) {
            return "Function" // Contructor
        }
        if (ts.isArrayLiteralExpression(tsNode) || ts.isTupleTypeNode(tsNode)) {
            return "Array"
        }
